 ...
 */
final class Version20191024104119 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE author ADD user_id INT');
        $this->addSql('UPDATE author SET user_id = 1');
        $this->addSql('ALTER TABLE author MODIFY COLUMN user_id INT NOT NULL');
